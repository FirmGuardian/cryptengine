...
var errs = map[string]ErrType{
	...
	"cryptCantDecodePrivatePEM":         {502, "Failed to decode PEM block of private key"},
	"cryptCantDecodePublicPEM":          {503, "Failed to decode PEM block of public key"},
	"cryptCantDecryptPrivateBlock":      {504, "Unable to decrypt private block"},
	"cryptCantParsePrivateKey":          {505, "Unable to parse decrypted private key"},
	"cryptCantParsePublicKey":           {506, "Unable to parse public key"},
